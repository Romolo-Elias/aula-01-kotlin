...
data class BottomNaviationItem(
    val tittle: String,
...
fun MyBottomAppBar(modifier: Modifier = Modifier) {
    val items = listOf(
        BottomNaviationItem("Home", icon = Icons.Default.Home),
        BottomNaviationItem("Favorites", icon = Icons.Default.Favorite),
        BottomNaviationItem("Profile", icon = Icons.Default.Person),
    )
